...
{
    public class AccountOpeningDetailPagedRequestValidator : AbstractValidator<AccountOpeningDetailPagedRequest>
    {
        public AccountOpeningDetailPagedRequestValidator()
        {
            ...
            // Ensure SortBy is a valid enum value
            RuleFor(x => x.SortBy)
                .IsInEnum()
            ...
            // Optional: Prevent massive filter strings from causing performance/injection issues
            RuleFor(x => x.FilterValue)
                .MaximumLength(100)
